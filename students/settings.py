...
SECRET_KEY = '2xbj-5$dc7s%uno7qper15t^zq2nd^yuu54_-$@^8q&1*t@kt0'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
                ...
                os.path.join(BASE_DIR, 'profile_maker', 'templates', 'profile_maker'),
                os.path.join(BASE_DIR, 'home', 'templates', 'home'),
                os.path.join(BASE_DIR, 'post', 'templates', 'post'),
